...
fn doctor_ip(server_ip_address: std::net::IpAddr, server_address: Option<&str>) {
    ...
    doctor_tcp(server_ip_address, "11114", "API");
    doctor_tcp(server_ip_address, "11115", "hbbs extra port for nat test");
    doctor_tcp(server_ip_address, "11116", "hbbs");
    doctor_tcp(server_ip_address, "11117", "hbbr tcp");
    doctor_tcp(server_ip_address, "11118", "hbbs websocket");
    doctor_tcp(server_ip_address, "11119", "hbbr websocket");
